...
import org.yiyi.seata.mapper.AccountMapper;
...
public class AccountService {
    ...
    public void charge (String accountNo, Double chargeAmount) {
        accountMapper.updateAccountBalance (accountNo, chargeAmount);
    }
}
