 ...
 */
package org.yiyi.seata.service;

import io.seata.spring.annotation.GlobalTransactional;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import org.yiyi.seata.client.AccountClient;
import org.yiyi.seata.client.OrderClient;
import org.yiyi.seata.mapper.BusinessMapper;
...
public class BusinessService {
    ...
    @GlobalTransactional
    public String buySomething (String accountNo, Double chargeAmount) {
        businessMapper.add (accountNo, chargeAmount);
        accountClient.charge (accountNo, chargeAmount);
        orderClient.create (accountNo);
        int i = 3/0;
        return "success";
    }
}
