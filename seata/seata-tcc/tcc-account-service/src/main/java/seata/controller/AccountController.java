...
public class AccountController {
    ...
    public String charge (@RequestParam("accountNo") String accountNo, @RequestParam("chargeAmount") Double chargeAmount) {
        System.out.println ("charge");
        return "success";
    }

    @RequestMapping("commitCharge")
    public String commitCharge (@RequestParam("accountNo") String accountNo, @RequestParam("chargeAmount") Double chargeAmount) {
        System.out.println ("commitCharge");
        return "success";
    }

    @RequestMapping("rollbackCharge")
    public String rollbackCharge (@RequestParam("accountNo") String accountNo, @RequestParam("chargeAmount") Double chargeAmount) {
        System.out.println ("rollbackCharge");
        return "success";
    }
}
