...
public class OrderController {
    ...
    public String create (@RequestParam("accountNo") String accountNo) {
        System.out.println ("create");
        return "success";
    }

    @RequestMapping("commitCreate")
    public String commitCreate (@RequestParam("accountNo") String accountNo) {
        System.out.println ("commitCreate");
        return "success";
    }

    @RequestMapping("rollbackCreate")
    public String rollbackCreate (@RequestParam("accountNo") String accountNo) {
        System.out.println ("rollbackCreate");
        return "success";
    }
}
