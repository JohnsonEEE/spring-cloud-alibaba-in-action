...
public class AccountClient {
    ...
    @TwoPhaseBusinessAction(name = "AccountClient" , commitMethod = "commitCharge", rollbackMethod = "rollbackCharge")
    public void charge (BusinessActionContext actionContext, String accountNo, Double chargeAmount) {
        String url = "http://127.0.0.1:8080/account/charge?accountNo=" + accountNo + "&chargeAmount=" + chargeAmount;
        try {
    ...
    public void commitCharge (BusinessActionContext actionContext, String accountNo, Double chargeAmount) {
        String url = "http://127.0.0.1:8080/account/commitCharge?accountNo=" + accountNo + "&chargeAmount=" + chargeAmount;
        try {
            restTemplate.getForEntity (url, Void.class);
        }
        catch (Exception e) {
    ...
    public void rollbackCharge (BusinessActionContext actionContext, String accountNo, Double chargeAmount) {
        String url = "http://127.0.0.1:8080/account/rollbackCharge?accountNo=" + accountNo + "&chargeAmount=" + chargeAmount;
        try {
            restTemplate.getForEntity (url, Void.class);
        }
        catch (Exception e) {
